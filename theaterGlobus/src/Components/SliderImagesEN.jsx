// src/components/SliderImagesEN.jsx
...
const SliderImagesEN = () => {
  ...
  const images = [
    ...
    },
    {
      ...
      alt: "Emotional performance scene — Theater Globus",
    },
    {
      src: "/images/9c6dcfdc-8579-4951-b8ab-69cb0acced48.jpg",
      alt: "Stage scenery and lighting at Theater Globus",
    },
    {
      src: "/images/0af4eebe-0091-4ee6-8c4a-13f396c2796a.jpg",
      alt: "Great performance moment at Theater Globus",
    },
    {
      src: "/images/64f9138e-544c-4436-b34c-d08238448e2c.jpg",
      alt: "Backstage preparation at Theater Globus",
    },
    {
          ...
          <div className="col-12 col-lg-3">
            <header className="content-wrapper">
              ...
              <p className="mbr-text display-7">
                The stage is a world where reality becomes art.
              </p>
            </header>
          </div>
